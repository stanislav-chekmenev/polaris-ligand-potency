...
class GAT(torch.nn.Module):
    def __init__(self, out_channels: int = 64, edge_dim=3):
        ...
        self.gat_conv1 = GATConv(in_channels=-1, out_channels=out_channels, edge_dim=cfg.EDGE_DIM)
        self.gat_conv2 = GATConv(in_channels=out_channels, out_channels=out_channels, edge_dim=cfg.EDGE_DIM)
